...
import com.lzyp.common.mob.LoginData;
import com.lzyp.common.mob.MobBean;
import com.lzyp.common.mob.MobCallback;
import com.lzyp.common.mob.MobLoginUtil;
...
import com.lzyp.main.adapter.LoginTypeAdapter;
import com.lzyp.main.dialog.LoginForbiddenDialogFragment;
import com.lzyp.main.event.RegSuccessEvent;
    ...
    public void onItemClick(MobBean bean, int position) {
        ...
        mLoginUtil.execute(bean.getType(), new MobCallback() {
            ...
            public void onSuccess(Object data) {
                Log.e("onSuccess","aaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
                if (data != null) {
