...
import com.lzyp.common.utils.DeviceUtils;
...
public class CommonAppConfig {
    public static final String PACKAGE_NAME = "com.lzyp.yyllzxc";
    //Http请求头 Header
    ...
    public static boolean isYunBaoApp() {
        if (!TextUtils.isEmpty(PACKAGE_NAME)) {
            return PACKAGE_NAME.contains("com.lzyp.phoneliv");
        }
        return false;
    }
    ...
    public String getAppName() {
        if (TextUtils.isEmpty(mAppName)) {
            int res = CommonAppContext.getInstance().getResources().getIdentifier("app_name", "string", "com.lzyp.yyllzxc");
    ...
    public int getAppIconRes() {
        if (mAppIconRes == 0) {
            mAppIconRes = CommonAppContext.getInstance().getResources().getIdentifier("icon_app", "mipmap", "com.lzyp.yyllzxc");
        }
        return mAppIconRes;
    }
